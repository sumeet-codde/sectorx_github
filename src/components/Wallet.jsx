...
const Wallet = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-slate-900 via-purple-900 to-slate-900">
      <div className="bg-gradient-to-r from-black via-purple-900 to-cyan-300" />
      <div className="flex w-full justify-center items-center">
        <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
          <div className=" flex flex-1 justify-start flex-col md:mr-10">
            ...
            >
              <p className="text-white text-base text-[14px] font-sans">
                {' '}
                Connect Wallet{' '}
              </p>
            </button>
          ...
          <div className="flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10">
            <div className="p-4 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 eth-card .white-glassmorphism ">
              <div className="flex justify-between flex-col w-full h-full">
                ...
                <div>
                  <p className="text-white font-serif text-sm">Blockchain</p>
